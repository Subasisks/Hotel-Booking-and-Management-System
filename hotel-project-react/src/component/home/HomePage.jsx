        ...
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    <img src="./assets/images/hotel.webp" alt="My Hotel Banner" className="header-image" />
                    <div className="overlay"></div>
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="my-color">My Hotel</span>
                        </h1><br />
            ...
            <h2 className="home-services">Services at <span className="my-color">My Hotel</span></h2>
